/// Square Enix Manga - Free content where available
use reqwest::Client;
use crate::models::{Manga, Chapter};
use scraper::{Html, Selector};

const BASE_URL: &str = "https://squareenixmangaandbooks.square-enix-games.com";
...
pub async fn search_manga_with_urls(
    ...
    let selectors = vec![
        "div.series-card a[href*=\'/series/\']",
        "article.series a[href*=\'/series/\']",
        "div.manga-item a[href*=\'/series/\']",
        "a.series-link[href*=\'/series/\']",
        "a[href*=\'/series/\']",
    ];
