...
pub async fn search_manga_with_urls(
    ...
    log::warn!("{} is a commercial/paid source and requires authentication", "Square Enix Manga");
    Ok(Vec::new())
}
